...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
            $upPage     =   "<a href='".str_replace('__PAGE__',$upRow,$url)."' class=\"pager-item\">".$this->config['prev']."</a>";
        }else{
            $upPage     =   '';
        }

        if ($downRow <= $this->totalPages){
            $downPage   =   "<a href='".str_replace('__PAGE__',$downRow,$url)."' class=\"pager-item\">".$this->config['next']."</a>";
        }else{
            $downPage   =   '';
        }
        // << < > >>
